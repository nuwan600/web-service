 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/NewWebService/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ws/", "NewWebService");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://ws/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "NewWebServicePort"), NewWebService.class, features);
    }
